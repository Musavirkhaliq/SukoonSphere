...
import { getMessages, sendMessage, markMessagesAsSeen,totalUnseenMessages, deleteAllMessages,deleteAllMessagesByChatId,deleteMessageById } from '../controllers/messageController.js';
...
router.get("/total-unseen/:userId", authenticateUser, totalUnseenMessages);
