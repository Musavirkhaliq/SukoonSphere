    ...
    <>
      <div className="bg-white p-4 rounded-lg shadow-sm border">
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          {user && user._id === (comment.createdBy?._id || comment.createdBy) && (
        ...
        {(comment.replies?.length > 0 || comment.totalReplies > 0) && (
          <div className="mt-4">
            ...
            >
              {showReplies
                ? "Hide Replies"
                : `Show ${comment.replies?.length || comment.totalReplies} ${
                    (comment.replies?.length || comment.totalReplies) === 1 ? "Reply" : "Replies"
                  }`}
            </button>
            {showReplies && (
